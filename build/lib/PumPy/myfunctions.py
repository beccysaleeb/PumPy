...
def startPump(pump, mode, duration):
...
def calibrateFlow(pump, repeats):
    sum = 0
...
def flowRate(pump, syringeLabel, csvPath, targetFlow):
    import pandas as pd
